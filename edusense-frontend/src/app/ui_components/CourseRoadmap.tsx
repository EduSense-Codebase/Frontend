                        ...
                        >
                            ...
                            <div className="relative flex w-full justify-center md:w-1/2">
                                ...
                                <motion.div
                                    ...
                                    className={`absolute -top-3 right-30 cursor-pointer rounded-full p-1 shadow-md transition-colors duration-200 ${
                                        isCompleted
                                ...
                                <motion.div
                                    whileHover={{ scale: 1.05, y: -5 }}
                                    transition={{ type: 'spring', stiffness: 300 }}
                                    className="w-[90%] max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow-xl md:p-8"
                                >
                                    <Link
