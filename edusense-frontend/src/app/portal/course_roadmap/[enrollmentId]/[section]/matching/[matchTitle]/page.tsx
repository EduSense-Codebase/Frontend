...
export default function MatchingPage() {
    ...
    const [pairResults, setPairResults] = useState<{ left: number; right: number; isCorrect: boolean }[]>([]);
    ...
    const handleSubmit = () => {
        ...
        const getTileStyle = (side: "left" | "right", index: number) => {
            ...
            if (match) {
              base += match.isCorrect ? " bg-green-100 border-green-500" : " bg-red-100 border-red-500";
            } else {
    ...
    return (
        <>
        <div className="min-h-screen flex flex-col items-center w-full justify-center bg-white px-4 pt-10 pb-24">
            <motion.div
            ...
            <div ref={containerRef} className="relative w-full h-full">
                {renderLines()}
                <div className="grid grid-cols-2 gap-60 relative z-10">
                {/* Left Tiles */}
                <div>
                    <h2 className="font-semibold mb-2">Match the tile on the left</h2>
                ...
                {/* Right Tiles */}
                <div>
                    <h2 className="font-semibold mb-2">... to the correct tiles on the right!</h2>
